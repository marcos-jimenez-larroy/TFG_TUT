...
using namespace RooFit;
    ...
    std::vector<TString> new_funcList = {
        "ExpPol3", //Bernstein da problemas por alguna razón
        "ExpPol3",
        "ExpPol3",
        "ExpPol3",
        "ExpPol3",
    ...
    void CrossSection_SS_method(){
        ...
        for(int i=0;i<16;i++){
            ...
            TString OutFileName = "/home/mjlarroy/TFG_TUT/figures/pdf_graphs/XS/22_23_CrossSection_SS_method_bin" + std::to_string(i) + ".pdf";
        ...
        canvas_cs->Print("/home/mjlarroy/TFG_TUT/figures/pdf_graphs/XS/22_23_CrossSection_SS_method_complete.pdf");

        TFile* myfile = new TFile("/home/mjlarroy/TFG_TUT/Root_Results/Experimental_CrossSection_22_23.root", "RECREATE"); //Recreate significa que si no está lo cree y si está que lo reescriba.
