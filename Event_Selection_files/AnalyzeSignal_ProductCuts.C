#define AnalyzeSignal_ProductCuts_cxx
#include "AnalyzeSignal_ProductCuts.h"
#include <TH2.h>
#include <TStyle.h>
#include "TH1D.h"
#include "TH2D.h"
...
void AnalyzeSignal_ProductCuts::Loop()
{
    ...
    double num_cuts = 31;
        ...
        double SumOfWeights = 226630780.; //SumofWeights del ggH
        ...
        for (Long64_t jentry=0; jentry<nentries;jentry++) {
            ...
            TFile* myfile = new TFile("/home/marcosj/HGamCore/New_Root/mc23a_signal_ProductCuts_RelativeCuts_ttH.root", "RECREATE"); //Recreate significa que si no está lo cree y si está que lo reescriba.
